  ...
  const modules = [
    {
      ...
      description:
        'Understand weights, biases, and the magic of the perceptron.',
      ...
      >
        <View style={{ gap: 20, paddingVertical: 10 }}>
          <View style={{ gap: 8 }}>
            ...
            <Text
              style={{ color: theme.colors.mutedForeground, lineHeight: 20 }}
            >
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            <Button
              style={{ flex: 1 }}
              onPress={() => navigate('/curriculum/lesson/losslandscape')}
            >
              Enter Module
            </Button>
