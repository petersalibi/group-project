...
import { 
  ...
  Database, Zap, TrendingUp, Layers, CheckCircle2, Lock
  ...
  return (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={[styles.sectionHeading, { color: brandAccent }]}>01. Neural Architecture</Text>
        <View style={styles.row}>
          ...
          <View style={styles.neuralNodeGroup}>
            <View style={[styles.neuralNode, { backgroundColor: '#C6F382', borderWidth: 2, borderColor: '#353F91' }]}>
              <Play color="#353F91" size={20} />
            </View>
            <Text style={styles.nodeLabel}>ACTIVE</Text>
          </View>
          <View style={styles.neuralNodeGroup}>
            <View style={[styles.neuralNode, { backgroundColor: theme.colors.muted }]}>
      ...
      <View style={styles.section}>
        <Text style={[styles.sectionHeading, { color: brandAccent }]}>02. Input Controls</Text>
        <View style={styles.grid}>
          ...
          <View style={styles.componentPreview}>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger>
                <View style={[styles.trigger, { borderColor: theme.colors.border }]}>
                  <Text style={{ fontSize: 12 }}>ReLU</Text>
                </View>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
                <DropdownMenuItem><Text>ReLU</Text></DropdownMenuItem>
                <DropdownMenuItem><Text>Sigmoid</Text></DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </View>
      ...
      <View style={styles.section}>
        <Text style={[styles.sectionHeading, { color: brandAccent }]}>03. Engine Overlay HUD</Text>
        <View style={[styles.engineMock, { backgroundColor: '#5B62B3' }]}>
          <View style={styles.playbackBar}>
            <View style={styles.playbackActions}>
              <SkipBack size={18} color="white" />
              <View style={styles.playBtn}><Play size={14} color="white" fill="white" /></View>
      ...
      <View style={styles.section}>
        <Text style={[styles.sectionHeading, { color: brandAccent }]}>04. Button Variants</Text>
        <View style={styles.row}>
          <Button variant="primary" size="sm">Primary Action</Button>
          <Button variant="secondary" size="sm">Secondary</Button>
          <Button variant="outline" size="sm">Outline</Button>
          <Button variant="outline" size="sm"><Palette size={16} color={theme.colors.foreground} /></Button>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  section: { gap: 16 },
  sectionHeading: { fontSize: 11, fontWeight: '900', letterSpacing: 1.5, textTransform: 'uppercase' },
  grid: { gap: 20 },
  row: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, alignItems: 'center' },
  neuralNodeGroup: { alignItems: 'center', gap: 8 },
  neuralNode: { width: 50, height: 50, borderRadius: 25, justifyContent: 'center', alignItems: 'center' },
  nodeLabel: { fontSize: 9, fontWeight: '800', opacity: 0.6 },
  componentPreview: { gap: 8 },
  previewLabel: { fontSize: 10, fontWeight: '700', opacity: 0.4 },
  trigger: { height: 36, borderWidth: 1, borderRadius: 8, justifyContent: 'center', paddingHorizontal: 12, width: 120 },
  engineMock: { height: 120, borderRadius: 12, padding: 20, justifyContent: 'flex-end' },
  playbackBar: { height: 44, backgroundColor: 'rgba(0,0,0,0.4)', borderRadius: 10, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, gap: 12 },
  playbackActions: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  playBtn: { width: 26, height: 26, borderRadius: 13, borderWidth: 1, borderColor: 'white', justifyContent: 'center', alignItems: 'center' },
