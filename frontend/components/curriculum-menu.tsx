...
export function CurriculumMenu({
  ...
  return (
    <View
      style={[
        styles.globalCurriculumOverlay,
        {
      ...
      <ScrollView contentContainerStyle={{ paddingVertical: 20 }}>
        <View style={styles.networkContainer}>
          ...
          <View style={styles.row}>
            <TouchableOpacity
              style={styles.col3}
              onPress={() => onNavigate?.('loss')}
            >
              <NeuralNode status={getStatus('loss')} label='Loss' />
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.col3}
              onPress={() => onNavigate?.('geometry')}
            >
...
const styles = StyleSheet.create({
  globalCurriculumOverlay: {
    ...
    top: 42,
    left: 0,
    width: 250, // Increased slightly to comfortably fit 3 nodes side-by-side
    maxHeight: '85%',
