...
print(f"Choosing random directions...")
...
print(f"Computing loss surface -- Linear Interpolation...")
A_1D, loss_line = compute_loss_function(model, X, y, pretrained_params)
print(f"Computing loss surface -- Random Directions...")
A, B, loss_rand = compute_loss_surface(model, X, y, rand_d1, rand_d2)
print(f"Computing loss surface -- Filterwise Normalised Directions...")
